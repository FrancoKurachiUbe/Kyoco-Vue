...
<div id="home" class="container-fluid"> 
    ...
    <div class="row justify-content-center bg-ff mt-4 px-3 py-3">
            <picture class="col-sm-11 col-md-5 col-lg-4 text-center my-auto">
                <img src="img/producto/Hologram.jpg" alt="vela en un vaso de vidrio">
            </picture>
    ...
    <div class="row justify-content-center mt-4 px-3 py-3">
        <div  class="col-sm-11 col-md-6 col-lg-5 my-auto">
            ...
            <h3 class="text-secondary font-weight-bold">Tips para una limpieza perfecta:</h3>
            <ul class="ml-4">
        ...
        <div class="col-sm-11 col-md-5 col-lg-4 text-center my-auto">
